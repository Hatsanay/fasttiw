                ...
                <Card className="p-6 sm:p-8 flex flex-col gap-6 text-sm text-slate-600 leading-relaxed">
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            รหัสผ่านที่เข้ารหัสแล้ว ประวัติการทำแนวข้อสอบและผลคะแนน ประวัติการสั่งซื้อ และข้อมูลการเข้าสู่ระบบ (วันเวลา อุปกรณ์/เบราว์เซอร์ และหมายเลข IP) ซึ่งท่านดูย้อนหลังได้เองที่หน้า บัญชีของฉัน
                        </p>
                    </section>
